...
# Installation de PHP 8.2 (minimum requis pour Laravel 11)
print_info "Installation de PHP 8.2..."
apt install -y php8.2 php8.2-cli php8.2-common php8.2-fpm php8.2-mysql \
    php8.2-zip php8.2-gd php8.2-mbstring php8.2-curl php8.2-xml php8.2-bcmath \
    php8.2-intl php8.2-readline php8.2-tokenizer php8.2-fileinfo php8.2-opcache
...
# Sécurisation de MariaDB (compatible avec les versions récentes)
...
# Vérification de la version de PHP requise
PHP_VERSION=$(php -r "echo PHP_VERSION;")
print_info "Version PHP installée: $PHP_VERSION"

# Installation des dépendances avec Composer
print_info "Installation des dépendances PHP..."
sudo -u www-data composer install --no-dev --optimize-autoloader

# En cas d'échec, essayer avec --ignore-platform-req
if [ $? -ne 0 ]; then
    print_warning "Installation standard échouée, tentative avec --ignore-platform-req=php"
